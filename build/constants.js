...
(function (Dimensions) {
    Dimensions["YEARLY"] = "yearly";
    Dimensions["WEEKLY"] = "weekly";
    Dimensions["MONTHLY"] = "monthly";
    Dimensions["HOURLY"] = "hourly";
    Dimensions["DAILY"] = "daily";
    Dimensions["MINUTELY"] = "minutely";
    Dimensions["SECONDLY"] = "secondly";
})(Dimensions || (Dimensions = {}));
export var BooleanAnswer;
(function (BooleanAnswer) {
    BooleanAnswer[BooleanAnswer["UNKNOWN"] = -1] = "UNKNOWN";
    BooleanAnswer[BooleanAnswer["FALSE"] = 0] = "FALSE";
    BooleanAnswer[BooleanAnswer["TRUE"] = 1] = "TRUE";
})(BooleanAnswer || (BooleanAnswer = {}));
export function getLuxonDateTime(options) {
...
export function training_on_progress({ completion_percentage, loss, epoch, status, logs, defaultLog = true }) {
    if (defaultLog)
        console.log({ completion_percentage, loss, epoch, status, logs });
}
export const mockDates = generatedMockDates;
export function getPartialHour(minute) {
...
export function getQuarterHour(parsedDate) {
...
export function getOpenHour(options = {}) {
    return 1;
    /*
    //TODO: fix this
...
export function getIsOutlier({ outlier_property, } = {}) {
    if (outlier_property) {
...
export function addMockDataToDataSet(DataSet, { mockEncodedData = [], includeConstants = true, }) {
...
export function removeMockDataFromDataSet(DataSet, { mockEncodedData = [], includeConstants = true, }) {
    const newMockData = new Array().concat(mockEncodedData, includeConstants ? mockDates : []);
