...
var _ModelX = class {
  ...
  async evaluateModel(options = {}) {
    ...
    const estimatesDescaled = estimatedValues.map((val, i) => {
      ...
      const formattedInverse = this.use_empty_objects ? flatten.unflatten(inverseTransformedObject, { delimiter: flattenDelimiter }) : inverseTransformedObject;
    ...
    const actualsDescaled = actualValues.map((val) => {
      ...
      return this.use_empty_objects ? flatten.unflatten(inverseTransformedObject, { delimiter: flattenDelimiter }) : inverseTransformedObject;
    });
