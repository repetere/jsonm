 ...
 *
 */
export function prng(len?:number) {
...
export function validate(param:string|number, type:string, defaultParam?:any) {
 ...
 */
export function rgamma(n:number, alpha:number, rate) {
 ...
 */
export function rbeta(n:number, alpha:number = 1, beta:number = 1, loc:number = 0) {
